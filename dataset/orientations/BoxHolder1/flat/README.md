...
**Модель:** BoxHolder1
**Углы поворота:** X=90°, Y=0°, Z=0°
**Описание:** Модель лежит на боку
...
2. Поверните модель на указанные углы:
   - Вращение X (наклон вперед/назад): 90°
...
- Запустите скрипт: `python src/fill_analysis.py "dataset\orientations\BoxHolder1\flat/model.stl"`
...
3. Экспортируйте G-code как `output.gcode` в `../gcode_results/BoxHolder1/flat/`
