...
- Запустите скрипт: `python src/fill_analysis.py "dataset\orientations\BoxHolder1\default/model.stl"`
...
3. Экспортируйте G-code как `output.gcode` в `../gcode_results/BoxHolder1/default/`
