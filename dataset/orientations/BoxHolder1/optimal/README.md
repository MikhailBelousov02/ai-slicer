...
1. Откройте файл `../models/BoxHolder1.stl` в Cura 5.11.0
...
- Запустите скрипт: `python src/fill_analysis.py "dataset\orientations\BoxHolder1\optimal/model.stl"`
...
3. Экспортируйте G-code как `output.gcode` в `../gcode_results/BoxHolder1/optimal/`
