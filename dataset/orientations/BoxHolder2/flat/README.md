...
- Запустите скрипт: `python src/fill_analysis.py "dataset\orientations\BoxHolder2\flat/model.stl"`
...
3. Экспортируйте G-code как `output.gcode` в `../gcode_results/BoxHolder2/flat/`
