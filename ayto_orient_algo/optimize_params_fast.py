...
# Предвычисление данных модели (один раз)
class PrecomputedModel:
    ...
    def evaluate_orientation(self, orientation, first_lay_h=0.0475, ascent=-0.0781, min_volume=False):
        # Вычисление bottom, overhang, contour для заданной ориентации. Возвращает (bottom, overhang, contour)
...
# Загрузка датасета с предвычислением
...
# Генетический алгоритм с прогрессом
...
# Тест на 10 моделях, 10 поколений, 3 случайные ориентации
    dataset = dataset[:30]
